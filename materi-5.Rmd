...
## 
>1. <h3> S3 Standard </h3>
terdapat istilah daya 11 sembilan <br>
Artinya: <br>
99,999999999% probabilitas tetap utuh setelah jangka waktu 1 tahun.
<br>
<br>
>2. <h3> S3 Standard-interfrequent Access (S3 Standard-Ai) </h3>
Sebagai penyimpanan backup(cadangan), disaster recovery file(file pemulihan bencana) atau yang membutuhkan penyimpanan janga panjang.

> 3. <h3> S3 Intelligent-Tiering </h3>
Pada penyimpanan S3 Intelligent-Tiering, Amazon S3 memantau pola akses objek. jika objek tidak di akses selama 30 hari, amazon S3 akan memindahkan secara otomatis ke standart-IA. <Br>

## 
>4. <h3>Glacier</h3>
> <div>Sebagai penyipanan data audit, yang tidak memerlukan proses akses yang langsung pada saat itu.</div>
<br>
...
>5. <h3>S3 Glacier Deep Archiver</h3> 
