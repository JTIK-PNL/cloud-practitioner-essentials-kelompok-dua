...
Ringkasannya, arsitektur kita telah berkembang menjadi elastis, diskalabel,tahan bencana, dan optimal secara biaya.Kita memiliki jaringan global yang aman dan dapat diprogram sepenuhnya. Dalam menghadapi pertumbuhan pelanggan, program loyalitas bisa menjadi solusi. 
Namun, untuk melacak dan mengenali pelanggan secara efektif,kartu digital dengan basis data yang tepat diperlukan, jadi membutuhkan penyimpanan dan database (basis data), bukan sembarang database, pilihlah penyimpanan dan database yang tepat sesuai dengan masing-masing kebutuhan. AWS menyediakan berbagai layanan yang cocok untuk membangun solusi data yang sesuai dengan kebutuhan.
