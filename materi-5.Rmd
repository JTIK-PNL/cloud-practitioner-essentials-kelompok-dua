...
## instance store dan amazon electis block store (amazon EBS)
...
<div class="fragment">
  Amazon S3 juga merupakan, object-level storage *Penyimpanan tingkat objek*. Setiap objek terdiri dari beberapa data, metadata,   dan kunci. <br>
  <div class="fragment">
  Ukuran Maximal dari  objek yang dapat di unnggah  yaitu 5 terabyte.
  </div> <br>
  <div class="fragment">
...
Artinya: <br>
99,999999999% probabilitas tetap utuh setelah jangka waktu 1 tahun.</div>

>2. <h4 class style=color:blue;> S3 Standard-interfrequent Access (S3 Standard-Ai) </h4>
<div class style=color:brown;> Sebagai penyimpanan backup(cadangan), disaster recovery file(file pemulihan bencana) atau yang membutuhkan penyimpanan janga panjang. </div>

> 3. <h4 class style=color:blue;> S3 Intelligent-Tiering </h4>
<div class style=color:brown; >Pada penyimpanan S3 Intelligent-Tiering, Amazon S3 memantau pola akses objek. jika objek tidak di akses selama 30 hari, amazon S3 akan memindahkan secara otomatis ke standart-IA. <Br>
...
> Kesimpulannya, jika memiliki objek atau file yang lengkap yang hanya membutuhkan sesekali perubahan, maka pilihlah Amazon S3. Jika membutuhkan proses read (baca) data yang kompleks, maka perlu memilih Amazon EBS.
</div>
...
Misalnya, seorang pelanggan ditoko kue telah memesan kue yang sama beberapa kali. Nah, melihat hal ini, kita sebagai pemilik toko kue ingin menawarkan diskon promosi untuk pembelian berikutnya.
Tentu, kita membutuhkan suatu cara untuk mencari relasi semacam ini, bukan?

Solusi terbaik untuk masalah tersebut adalah dengan menggunakan (RDBMS) Artinya, data yang kita simpan dapat memiliki relasi dengan bagian data lainnya.
